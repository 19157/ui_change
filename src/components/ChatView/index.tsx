...
const ChatView: GenieType.FC<Props> = (props) => {
  ...
  const sendDataMessage = (inputInfo: any) => {
    ...
    // todo 测试
    // console.log('测试---', sessionId)
    // dispatch(setChatListStore([
    //   {
    //     id: sessionId,
    //     title: "chat_" + sessionId,
    //     createdAt: "2025-10-22 16:50:00",
    //     updatedAt: "2025-10-22 16:50:00",
    //   },
    //   ...chatListStore,
    // ]))
    // setTimeout(() => {
    //   // navigate(`/${sessionId}?from=newCreate`, { replace: true });
    //   navigate(`/${sessionId}?from=newCreate`);
    // }, 500)
